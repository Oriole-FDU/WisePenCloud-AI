...
def llm_clients(monkeypatch):
    ...
    for module_name in (
        "chat.application.utils.llm_clients",
        "chat.application.utils.llm_clients.embedding",
        "chat.application.utils.llm_clients.query",
    ):
        monkeypatch.delitem(sys.modules, module_name, raising=False)

    return importlib.import_module("chat.application.utils.llm_clients")
