...
def resolve_note_tool_context(
    ...
    client_content_signature_value = _state_value(all_states, "note_client_content_signature")
    client_content_signature = (
        client_content_signature_value.strip()
        if isinstance(client_content_signature_value, str)
        else None
    )
    client_content_signature = client_content_signature or None
    ...
    return NoteToolContext(
        ...
        client_content_signature=client_content_signature,
    )
