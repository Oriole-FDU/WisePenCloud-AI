...
if TYPE_CHECKING:
    ...
    from chat.application.rag.graph_projection.models import KnowledgeGraphProjection
    from chat.application.rag.graph_extraction.models import KnowledgeExtractionSource
    from chat.application.rag.ingestion.models import RagContentProjection
    from chat.application.rag.ingestion.revision import (
