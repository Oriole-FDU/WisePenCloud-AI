...
def build_qdrant_permission_filter(scope: RagPermissionScope) -> qdrant_models.Filter:
    """生成 Qdrant Resource VIEW 权限过滤条件。"""
    ...
    group_filters = _build_qdrant_group_filters(scope)
    if group_filters:
...
def build_neo4j_permission_predicate(
    scope: RagPermissionScope,
    *,
    node_alias: str,
) -> tuple[str, dict[str, Any]]:
    """生成 Neo4j Resource VIEW 权限谓词及参数。"""
