...
async def file_read(request: FileReadRequest, req: Request,
    ...
    try:
        ...
        log_error("sandbox gateway file/read 代理失败", e, file=request.file)
...
async def file_write(request: FileWriteRequest, req: Request,
    ...
    try:
        ...
        log_error("sandbox gateway file/write 代理失败", e, file=request.file)
...
async def file_list(request: FileListRequest, req: Request,
    ...
    try:
        ...
        log_error("sandbox gateway file/list 代理失败", e, path=request.path)
...
async def file_grep(request: FileGrepRequest, req: Request,
    ...
    try:
        ...
        log_error("sandbox gateway file/grep 代理失败", e, path=request.path)
...
async def file_replace(request: FileReplaceRequest, req: Request,
    ...
    try:
        ...
        log_error("sandbox gateway file/replace 代理失败", e, file=request.file)
